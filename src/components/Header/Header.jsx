...
import { BearSpreader, Name } from 'Components';
      ...
      <header className='app-header'>
        <div className='contact-section'>
          <svg
            ...
            width='24' height='24'
            viewBox='0 0 172 172'
            style={{ fill: '#000000' }} onClick={() => OutsideLink('linkedin')}
          ...
          <svg
            ...
            width='24' height='24'
            viewBox='0 0 172 172'
            style={{ fill: '#000000' }} onClick={() => OutsideLink('github')}
        ...
        <div className='title-bar' onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)}>
          <BearSpreader />
          <Name hover={hover} />
